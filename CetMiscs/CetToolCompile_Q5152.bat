...
set BUILD_DIR=%TARGET_DIR%\build-%ProjectName%-Desktop_Qt_5_15_2_MinGW_32bit-Release
if not exist %BUILD_DIR% (
	@echo [创建目录]: %BUILD_DIR%
	mkdir %BUILD_DIR%
)

set QT_MAKE="D:\qtcomplies\mingw81_32\bin\qmake.exe"
set COMPILE_MAKE="D:\qtcomplies\Tools\mingw810_32\bin\mingw32-make.exe"
